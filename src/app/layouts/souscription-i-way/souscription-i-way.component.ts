...
@Component({
  selector: 'app-souscription-i-way',
  templateUrl: './souscription-i-way.component.html',
  styleUrls: ['./souscription-i-way.component.css']
})
export class SouscriptionIWAYComponent {
  ...
  getSunscriptionBYID(){
    this.souscriptionService.getSouscriptionIWAY(this.globalCustomerID).subscribe((cusSubscription: any) => {
