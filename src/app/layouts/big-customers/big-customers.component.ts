...
@Component({
  selector: 'app-big-customers',
  templateUrl: './big-customers.component.html',
  styleUrls: ['./big-customers.component.css']
})
export class BigCustomersComponent implements OnInit {
  ...
  constructor(
    ...
    private customersService: BigCustomerServiceService
    ){
  ...
  onSubmitCustomers(){
    ...
    if(this.edidtMode){
      ...
      console.log(customers)
       ...
       const bigCustomer$ = this.customersService.createBigCustomer(customers);

       bigCustomer$.subscribe((custom)=>{
        if(custom){
  ...
  onUpdateCustomers(customerId: any){
    ...
    this.router.navigateByUrl(`big-customers/${customerId}`)
  ...
  // site for customer
  customerSite(customerId: any){
    this.router.navigateByUrl(`customerSite?id=${customerId}`)
  ...
  onNavigate(customerId: any){
    ...
    //this.router.navigateByUrl('/big-customer-reciept/'+customerId)
    this.router.navigateByUrl('/unique-big-customer-bill/'+customerId);

  }
  onIwaySubscription(customerId: any){
    this.router.navigateByUrl('/i-way-soubscription/'+customerId)
  }

  onBlooStar(customerId: any){
    this.router.navigateByUrl('/bloo-star/'+customerId)
  }
  subscription(customerId: any){
    this.router.navigateByUrl(`big-subscription?id=${customerId}`)
  }
  bigPayment(customerId: any){
    this.router.navigateByUrl(`big-payments?id=${customerId}`)
  }
